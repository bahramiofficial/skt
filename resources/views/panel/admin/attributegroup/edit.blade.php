<x-panel-layout>
  ...
  <div class="breadcrumb">
      <ul>
          ...
          <li><a href="{{ route('admin.attributegroup.index') }}" class="">پیست</a></li>
          <li><a href="{{ route('admin.attributegroup.create') }}" class="is-active">ویرایش پیست</a></li>
      </ul>
    </div>
    <div class="main-content font-size-13">
        <div class="row no-gutters  bg-white">
            <div class="col-12">
                ...
                {{-- {{ route('tracks.store') }} --}}
                <form action="{{ route('admin.attributegroup.update',$track->id ) }}" class="padding-30" method="post" enctype="multipart/form-data" >
                    @csrf
                    @method('put')
